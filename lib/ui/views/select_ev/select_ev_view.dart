...
import 'select_ev_viewmodel.dart';

import 'package:spare_shop/ui/common/app_colors.dart';
import 'package:spare_shop/ui/widgets/common/voltspare_widgets.dart';

class SelectEvView extends StackedView<SelectEvViewModel> {
  const SelectEvView({Key? key}) : super(key: key);

  @override
  void onViewModelReady(SelectEvViewModel viewModel) {
    viewModel.init();
  ...
  @override
  SelectEvViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      SelectEvViewModel();
}
